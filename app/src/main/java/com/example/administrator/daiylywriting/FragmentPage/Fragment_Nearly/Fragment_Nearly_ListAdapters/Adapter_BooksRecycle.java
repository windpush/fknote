...
import com.example.administrator.daiylywriting.StaticModels.BookModel;
...
//                    setSelectorList(viewHolder.cardView);
            ...
            viewHolder.bookDiv.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    MyDialog myDialog = new MyDialog();
                    final Dialog changeBookName = myDialog.createDialog(mContext, R.style.popupDialog);
                    Window window = changeBookName.getWindow();
                    ...
                    okTextView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            bookModels.get(i).setBookName(bookNameVaule.getText().toString());
                            greenDaoService.saveBookLists(bookModels);
                            changeBookName.dismiss();
                            notifyItemChanged(i);
                        }
                    });
                    okTextView.setClickable(false);
                    bookNameVaule.setHint("输入你要修改的小说名！");
    ...
    public int getItemCount() {
        /**
         *  It need one more length for com.example.administrator.daiylywriting.adapter ,because the first item is used to be the addPart!
         */

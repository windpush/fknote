...
public class FragmentViews_Nearly extends LinearLayout {
    ...
    private RelativeLayout mRecentActivityDiv;
    private TextView mRecentActivity;
    private TextView mRecentActivityText;
    private RelativeLayout mRecentBooksDiv;
    private TextView mRecentBooks;
    private TextView mRecentBooksText;
    ...
    public FragmentViews_Nearly(Context context,BaseFragment baseFragment) {
        ...
        totalNumber = (TextView) findViewById(R.id.totalNum);

...
public class ActivityViews_MainActivity extends RelativeLayout {
    ...
    private ImageView mNearlypoint;
    private ImageView mNewcreatepoint;
    private ImageView mPushpoint;
    private ImageView mMepoint;
    private ImageView mToolpoint;
    private android.support.v4.view.ViewPager mMainBodyDiv;
    ...
    private final int VIEWPAGER_TOOL = 2;
    ...
    private void initViewpages() {
        ...
        mMainBodyDiv.setOffscreenPageLimit(3);

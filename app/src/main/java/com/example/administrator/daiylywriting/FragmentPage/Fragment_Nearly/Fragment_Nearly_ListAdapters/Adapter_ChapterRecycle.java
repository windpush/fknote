...
import com.example.administrator.daiylywriting.FragmentPage.Fragment_Nearly.EditActivity.EditMYActivity;
...
public class Adapter_ChapterRecycle extends RecyclerView.Adapter<Adapter_ChapterRecycle.ChapterViewHolder> {
    ...
    public void onBindViewHolder(final ChapterViewHolder holder, final int position) {
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog deleteDialog = myDialog.deleteDialog(activity, R.style.popupDialog);
                deleteDialog.setTitle("你确定以及肯定要删除此章节么？");
                Window pushWindow = deleteDialog.getWindow();
                TextView yes = (TextView) pushWindow.findViewById(R.id.yes);
                TextView no = (TextView) pushWindow.findViewById(R.id.no);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        charpterses.get(position).setIsDeleted(true);
                        greenDaoService.saveOrReplacChapters(charpterses.get(position));
                        notifyItemRemoved(position);
                        charpterses.remove(position);
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activityEdit.startActivityForResult(intent,21);
            }
        });
        ...
        /**
         * change the chapterName
         */
        holder.chapterDiv.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                ...
                chapterNameVaule.setHint("请输入你要修改的章节名！");
                ...
                okTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                         ...
                         *create new chapters
                         */
                        Charpters charpters = charpterses.get(position);
                        charpters.setCharpterName(chapterNameVaule.getText().toString());
                        greenDaoService.saveOrReplacChapters(charpters);
    ...
    public static class ChapterViewHolder
        ...
        private RelativeLayout chapterDiv;
        ...
        public ChapterViewHolder(View v) {
            ...
            chapterDiv= (RelativeLayout) v.findViewById(R.id.chapterDiv);
        }
    }
